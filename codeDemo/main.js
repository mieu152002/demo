...
var num_page 
// dùng để đếm số trang tùy vào mình chia hiển thị bao nhiêu trên 1 trang
// mình làm function tạo slide trước
function makeslide(numberonetime) {
    //truyền vào số ô muốn hiển thị trên 1 slides
...
// tính độ dài của từng slide
    ...
    slide.forEach((e, index) => {
        e.style.width = (slidegr.offsetWidth/100*percentwidth_slide) + "px";
        // set độ rộng của từng slide
    })
    
    slides.style.width = (slidegr.offsetWidth/100*percentwidth_slide)*slide.length+"px";
    // console.log(slidegr.offsetWidth/100*percentwidth_slide*7)
}
// truyền số ô muốn hiển thị
makeslide(3)
